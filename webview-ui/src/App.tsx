...
const App = () => {
	...
	const isChatTab = useMemo(() => tab === "chat", [tab])
	...
	const [activeTab, setActiveTab] = useState<ChatTab>("agent")
		...
		<>
			...
			{isChatTab && (
				<div className="header flex items-center justify-between">
					<TabList
						value={activeTab}
						onValueChange={(val) => setActiveTab(val as ChatTab)}
